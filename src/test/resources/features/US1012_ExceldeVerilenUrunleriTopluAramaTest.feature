...
Feature:US1012 Kullanici excelde verilen urunler icin arama testi yapar

  Scenario Outline: TC18 excelde verilen urunlerin arama sonuc sayisinin excel'de verilen minumum sonuc sayisindan buyuk esit oldugunu test eder
